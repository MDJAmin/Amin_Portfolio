...
export const About = () => {
  const frontendSkills = ["React", "TypeScript", "TailwindCSS", "MUI", "ThreeJs", "Gsap"];

  const backendSkills = ["Node.js", "Python", "AWS", "MongoDB", "GraphQL"];

  const designSkills = ["Adobe Pro", "Figma", "Blender", "AE", "AI"];

  const otherSkill = ["Model Optimization", "DQN", "Computer Vision", "NLP"];
