...
const skillSections = [
    ...
    },
    {
        ...
        skills: [
            ...
            { name: "Mongoose", description: "A lightweight Node.js web framework for building web applications." },
            { name: "Bcrypt.js", description: "A lightweight Node.js web framework for building web applications." },
            { name: "Nodemon", description: "A lightweight Node.js web framework for building web applications." },
            { name: "Multer", description: "A lightweight Node.js web framework for building web applications." },
        ],
    },
    {
        title: "Design",
        skills: [
            ...
            { name: "After Effects", description: "Adobe After Effects for motion graphics and visual effects." },
            { name: "Illustrator", description: "Adobe Illustrator for vector graphics and illustrations." },
            { name: "PhotoShop", description: "Adobe Illustrator for vector graphics and illustrations." },
        ],
    },
    {
        title: "Other",
